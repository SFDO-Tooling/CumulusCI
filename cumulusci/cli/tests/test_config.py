...
class TestCliConfig(unittest.TestCase):
    ...
    def test_load_project_config_no_file(self):
        ...
        config.global_config.get_project_config = mock.Mock(side_effect=ProjectConfigNotFound)
        config._load_project_config()
    ...
    def test_get_org_default(self):
        ...
        config.keychain.get_default_org.return_value = (
            'test', org_config
        )
    ...
    def test_check_org_overwrite_scratch_exists(self):
        config = CliConfig()
        config.keychain.get_org = mock.Mock(return_value=OrgConfig({
            'scratch': True,
            'created': True,
        }, 'test'))
