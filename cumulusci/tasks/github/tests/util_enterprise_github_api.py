...
class EnterpriseGithubApiTestMixin(object):
    ...
    def _get_expected_user(self, name):
        user_url = "https://github.fake-company.com/api/v3/users/{}".format(name)
        return {
            "id": 1234567892,
            "login": name,
            "url": user_url,
            ...
            "gravatar_id": "",
            "html_url": "https://github.fake-company.com/{}".format(name),
    ...
    def _get_expected_repo(self, owner, name):
        html_url = "https://github.fake-company.com/{}/{}".format(owner, name)
        url = "https://github.fake-company.com/api/v3/repos/{}/{}".format(owner, name)
        owner_url = "https://github.fake-company.com/api/v3/users/{}".format(owner)
        ...
        response_body = {
            ...
            "owner": {
                ...
                "avatar_url": "https://avatars2.githubusercontent.com/u/42554011?v=4",
                "gravatar_id": "",
                "html_url": "https://github.fake-company.com/{}".format(owner),
    ...
    def _get_expected_pull_request(
        ...
        pr = {
            ...
            "html_url": "https://github.fake-company.com/TestOwner/TestRepo/pulls/{}".format(
                issue_number
            ),
            "id": pull_id,
            ...
            "url": "https://github.fake-company.com/TestOwner/TestRepo/pulls/{}".format(
                issue_number
            ),
    ...
    def _get_expected_issue(self, issue_number, owner=None, repo=None, labels=None):
        ...
        response_body = {
            ...
            "created_at": now,
            "events_url": "",
            "html_url": "https://github.fake-company.com/{}/{}/issues/{}".format(
            ...
            "title": "Found a bug",
            "updated_at": now,
            "url": "https://github.fake-company.com/api/v3/repos/{}/{}/issues/{}".format(
                owner, repo, issue_number
            ),
    ...
    def _get_expected_label(self, name=None, desc=None):
        return {
            ...
            "url": "https://github.fake-company.com/api/v3/repos/octocat/Hello-World/labels/bug",
    ...
    def _get_expected_gist(self, description, files, public=False):
        ...
        expected_gist = {
            "url": f"https://github.fake-company.com/api/v3/gists/{gh_id}",
            "forks_url": f"https://github.fake-company.com/api/v3/gists/{gh_id}/forks",
            "commits_url": f"https://github.fake-company.com/api/v3/gists/{gh_id}/commits",
            "id": gh_id,
            ...
            "comments": 0,
            "user": None,
            "comments_url": f"https://github.fake-company.com/api/v3/gists/{gh_id}/comments/",
            "owner": {
                "login": "octocat",
                "id": 1,
                "node_id": "MDQ6VXNlcjE=",
                "avatar_url": "https://github.fake-company.com/images/error/octocat_happy.gif",
                "gravatar_id": "",
                "url": "https://github.fake-company.com/api/v3/users/octocat",
                "html_url": "https://github.fake-company.com/octocat",
                "followers_url": "https://github.fake-company.com/api/v3/users/octocat/followers",
                "following_url": "https://github.fake-company.com/api/v3/users/octocat/following{/other_user}",
                "gists_url": "https://github.fake-company.com/api/v3/users/octocat/gists{/gist_id}",
                "starred_url": "https://github.fake-company.com/api/v3/users/octocat/starred{/owner}{/repo}",
                "subscriptions_url": "https://github.fake-company.com/api/v3/users/octocat/subscriptions",
                "organizations_url": "https://github.fake-company.com/api/v3/users/octocat/orgs",
                "repos_url": "https://github.fake-company.com/api/v3/users/octocat/repos",
                "events_url": "https://github.fake-company.com/api/v3/users/octocat/events{/privacy}",
                "received_events_url": "https://github.fake-company.com/api/v3/users/octocat/received_events",
                "type": "User",
                "site_admin": False,
            },
            "truncated": False,
            ...
            "history": [
                {
                    "url": "https://github.fake-company.com/api/v3/gists/aa5a315d61ae9438b18d/57a7f021a713b1c5a6a199b54cc514735d2d462f",
