...
from cumulusci.tasks.github.tests.util_enterprise_github_api import (
    EnterpriseGithubApiTestMixin,
)
from cumulusci.tests.util import create_project_config


@mock.patch("cumulusci.tasks.github.release.time.sleep", mock.Mock())
class TestCreateRelease(unittest.TestCase, EnterpriseGithubApiTestMixin):
    def setUp(self):
        self.repo_owner = "TestOwner"
        self.repo_name = "TestRepo"
        self.repo_api_url = "https://github.fake-company.com/api/v3/repos/{}/{}".format(
            ...
            ServiceConfig(
                {
                    "username": "TestUser",
                    "password": "TestPass",
                    "enterprise_url": "https://github.fake-company.com",
