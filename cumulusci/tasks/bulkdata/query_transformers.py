...
class LookupTransformer(QueryTransformer):
    def __init__(self, mapping, metadata, model) -> None:
...
class RecordTypeTransformer(QueryTransformer):
    def __init__(self, mapping, metadata, model) -> None:
        super().__init__(mapping, metadata, model)
...
class MappingFilterTransformer(QueryTransformer):
    @cached_property
    def filters_to_add(self):
...
class PersonAccountTransformer(QueryTransformer):
