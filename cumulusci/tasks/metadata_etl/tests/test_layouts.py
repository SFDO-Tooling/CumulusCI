...
class TestAddFieldsToPageLayout(unittest.TestCase):
    ...
    def test_ensure_minimum_set_field(self):
        """Check the required optiosn are supplied for field relative positioning"""
    ...
    def test_ensure_minimum_set_section(self):
        """Check the required optiosn are supplied for section relative positioning"""
