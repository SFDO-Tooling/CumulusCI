...
* NEW TASK: ReportPushFailures pulls a list of Package Push Upgrade Request failures after a push attempt, including grouping by important factors. Since this task is for packaging orgs only, you'll need to wire it up in your local ~.cumulusci/cumulusci.yml.
