...
-   When using Playwright instead of Selenium, we now have limited support writing keywords in JavasSript. For more information see the topic "Writing keywords in JavaScript" in the documentation under "Playwright Technology Preview". (#3378)
