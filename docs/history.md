...
- @W-21875476: Phase 0 CI workflow updates by [@jstvz](https://github.com/jstvz) in [#3964](https://github.com/SFDO-Tooling/CumulusCI/pull/3964)

## New Contributors

- @dependabot[bot] made their first contribution in [#3965](https://github.com/SFDO-Tooling/CumulusCI/pull/3965)

**Full Changelog**: https://github.com/SFDO-Tooling/CumulusCI/compare/v4.9.0...v4.10.0
...
- Remove PyFilesystem2 dependency @W-21244194 by [@jstvz](https://github.com/jstvz) in [#3923](https://github.com/SFDO-Tooling/CumulusCI/pull/3923)
- Expose Rollback Option in the Snowfakery Task by [@aditya-balachander](https://github.com/aditya-balachander) in [#3958](https://github.com/SFDO-Tooling/CumulusCI/pull/3958)

**Full Changelog**: https://github.com/SFDO-Tooling/CumulusCI/compare/v4.8.1...v4.9.0
...
- Add output_dir option to retrieve_changes task by [@vsbharath](https://github.com/vsbharath) in [#3901](https://github.com/SFDO-Tooling/CumulusCI/pull/3901)

### Issues Fixed

- fix: Pin docutils<=0.21.2 to fix rst2ansi incompatibility by [@jstvz](https://github.com/jstvz) in [#3914](https://github.com/SFDO-Tooling/CumulusCI/pull/3914)
- Pin Click to version 8.2.0 by [@jstvz](https://github.com/jstvz) in [#3915](https://github.com/SFDO-Tooling/CumulusCI/pull/3915)
- migrate entrypoints handling to standard library importlib.metadata by [@rupeshjSFDC](https://github.com/rupeshjSFDC) in [#3904](https://github.com/SFDO-Tooling/CumulusCI/pull/3904)

## New Contributors

- @rupeshjSFDC made their first contribution in [#3904](https://github.com/SFDO-Tooling/CumulusCI/pull/3904)
