...
Note that the value of the ``server_key`` environment variable is the content of the file ``server.key``, which was created as part of your Connected App setup.
