...
test case: [Run Task](https://claritisoftware.github.io/CumulusCI/Keywords.html#CumulusCI.Run-Task) and [Run Task
Class](https://claritisoftware.github.io/CumulusCI/Keywords.html#CumulusCI.Run-Task-Class).

[Run Task](https://claritisoftware.github.io/CumulusCI/Keywords.html#CumulusCI.Run-Task) can be used to run any
...
[Run Task Class](https://claritisoftware.github.io/CumulusCI/Keywords.html#CumulusCI.Run-Task-Class) works in a
...
Time](https://claritisoftware.github.io/CumulusCI/Keywords.html#Salesforce.Set-Test-Elapsed-Time) keyword
...
Timer](https://claritisoftware.github.io/CumulusCI/Keywords.html#Salesforce.Start-Performance-Timer) keyword
...
The [Set Test Metric](https://claritisoftware.github.io/CumulusCI/Keywords.html#Salesforce.Set-Test-Metric)
...
Record](https://claritisoftware.github.io/CumulusCI/Keywords.html#Salesforce.Elapsed-Time-For-Last-Record)
...
-   [Salesforce Collection
    Insert](https://claritisoftware.github.io/CumulusCI/Keywords.html#Salesforce.Salesforce-Collection-Insert):
    Creates a collection of objects based on a template.
-   [Salesforce Collection
    Update](https://claritisoftware.github.io/CumulusCI/Keywords.html#Salesforce.Salesforce-Collection-Update):
    Updates a collection of objects.
-   [Salesforce Delete](https://claritisoftware.github.io/CumulusCI/Keywords.html#Salesforce.Salesforce-Delete):
    Deletes a record using its type and ID.
-   [Salesforce Get](https://claritisoftware.github.io/CumulusCI/Keywords.html#Salesforce.Salesforce-Get): Gets a
    dictionary of a record from its ID.
-   [Salesforce Insert](https://claritisoftware.github.io/CumulusCI/Keywords.html#Salesforce.Salesforce-Insert):
    Inserts a record using its type and field values. Returns the ID.
-   [Salesforce Query](https://claritisoftware.github.io/CumulusCI/Keywords.html#Salesforce.Salesforce-Query):
    Runs a simple query using the `object type` and `<field_name=value>`
    syntax. Returns a list of matching record dictionaries.
-   [Salesforce Update](https://claritisoftware.github.io/CumulusCI/Keywords.html#Salesforce.Salesforce-Update):
    Updates a record using its type, ID, and `<field_name=value>`
    syntax.
-   [SOQL Query](https://claritisoftware.github.io/CumulusCI/Keywords.html#Salesforce.SOQL-Query): Runs a SOQL
    query and returns a REST API result dictionary.

Using Page Objects -----------------

The
[PageObjects](https://claritisoftware.github.io/CumulusCI/Keywords.html#file-cumulusci.robotframework.PageObjects)
...
-   [cumulusci.robotframework.pageobjects.BasePage](https://claritisoftware.github.io/CumulusCI/Keywords.html#file-cumulusci/robotframework/pageobjects/BasePageObjects.py) A generic base class used by the other pageobject classes. Use the `BasePage` class for creating custom page objects when none of the other base classes make sense.
...
-   [Current Page Should
    Be](https://claritisoftware.github.io/CumulusCI/Keywords.html#PageObjects.Current-Page-Should-Be)
-   [Get Page Object](https://claritisoftware.github.io/CumulusCI/Keywords.html#PageObjects.Get-Page-Object)
-   [Go To Page
    Object](https://claritisoftware.github.io/CumulusCI/Keywords.html#PageObjects.Go-To-Page-Object)
-   [Load Page Object](https://claritisoftware.github.io/CumulusCI/Keywords.html#PageObjects.Load-Page-Object)
-   [Log Page Object
    Keywords](https://claritisoftware.github.io/CumulusCI/Keywords.html#PageObjects.Log-Page-Object)
-   [Wait For Modal](https://claritisoftware.github.io/CumulusCI/Keywords.html#PageObjects.Wait-For-Modal)
-   [Wait For Page
    Object](https://claritisoftware.github.io/CumulusCI/Keywords.html#PageObjects.Wait-For-Page-Object)
