...
-   triage test: `cumulusci/tests/triage/test_issue_3602.py` Working tree: the triage worktree on the triage worktree off `origin/dev` at `1925a3083`. Triaged 3 issues (#3910, #3306, #710). All three remain actionable on dev: #3910 has an open fix PR; #3306 and #710 are never-implemented enhancements.
