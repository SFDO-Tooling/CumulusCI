...
**Theme**: `cli`
**Issue**: <https://github.com/SFDO-Tooling/CumulusCI/issues/3470>
...
`cumulusci/cumulusci.yml` lines 823-835
...
`cumulusci/tests/triage/test_issue_3470.py`. Remove the `@pytest.mark.xfail` marker and confirm green.

## Full narrative

See `docs/triage/v5/repro-results.md` (search for `### #3470:`).
