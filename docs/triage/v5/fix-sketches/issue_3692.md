...
-   pass1: keep-open - add `digitalExperiences` (and likely `digitalExperienceConfigs`) entries to `metadata_map.yml` with appropriate parser classes (probably a bundle parser).
